...
//image[chap00-preface/voiceflow_01][The Fable team packaging up boxes of stories to be delivered]
...
@<icon>{chap00-preface/voiceflow_03}
...
@<icon>{chap00-preface/voiceflow_04}
...
@<icon>{chap00-preface/voiceflow_05}
...
@<icon>{chap00-preface/voiceflow_06}
...
//@<icon>{chap00-preface/voiceflow_07}
...
@<icon>{chap00-preface/voiceflow_08}
