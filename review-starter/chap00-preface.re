= まえがき
@<br>{}
本書を手に取っていただき、ありがとうございます。@<br>{}@<br>{}

AIやクラウドコンピューティングの進化により、音声アプリケーションは飛躍的に使いやすくなり身近なモノになりつつあります。
また、これからは音声UIを備えるモノが増え、音声UXの担う役割はますます重要になるでしょう。@<br>{}
本書は、ノンコーディングで音声アプリケーションを作成できるサービス「Voiceflow」についてわかりやすく解説した本です。@<br>{}
この本には、Voiceflowの使い方だけにとどまらず、VUI/VUX界における著名な方々における、音声アプリケーションの作成手法や勘所などのエッセンスが詰まっており、まさに虎の巻といえるものになっています。@<br>{}
エンジニアの方に読んでいただくのももちろん光栄ですが、コーディングをしない全ての職業・職種の方、小中学生を含めた学生の方に読んでいただき、この本が、音声UIの世界に一歩踏み入れるきっかけになってくれれば幸いです。
